		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Edit Leave Request</h4>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form action="{{route('employee_leave.update',$model->id)}}" method="POST">
                     @csrf
					  <div class="row">
						<div class="col-12">
                                            ...
                                            <select name="employee_id" id="employee_id" class="form-control">
                                                ...
                                                @foreach($employees as $key => $employee)
                                                       <option value="{{$employee->id}}" 
                                                        {{ ($model->employee_id == $employee->id ) ? 'selected':'' }}>
                                        ...
                                        <div class="controls">
                                                ...
                                                @foreach($leave_purpose as $key => $purpose)
                                                       <option value="{{$purpose->id}}"
                                                          {{ ($model->leave_purpose_id == $purpose->id ) ? 'selected':'' }}
                                                        >{{$purpose->name}}</option>
                                                @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                       <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="applied_from" class="form-control" value="{{$model->applied_from}}" />
                                            @error('applied_from')
                                                <span class="text-danger">{{ $message}}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="applied_to" class="form-control" value= "{{$model->applied_to}}" />
                                            @error('applied_to')
                                                <span class="text-danger">{{ $message}}</span>
                                            @enderror
                                        </div>
